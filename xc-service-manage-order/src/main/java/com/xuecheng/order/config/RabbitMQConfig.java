...
public class RabbitMQConfig {
     ...
     */
    @Bean
    public Binding binding_queue_finishaddchoose_processtask(@Qualifier(XC_LEARNING_FINISHADDCHOOSECOURSE) Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
